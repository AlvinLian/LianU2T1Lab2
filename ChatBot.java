public class ChatBot {
    ...
    // method that prints an inspirational quote
    public void inspirationalQuote() {
        System.out.println("'Success is not final;");
        System.out.println("Failure is not final;");
        System.out.println("It is the courage to continue that counts.'");
        System.out.println("- Winston Churchill");
    }


    // method that calculates and returns the user's age
